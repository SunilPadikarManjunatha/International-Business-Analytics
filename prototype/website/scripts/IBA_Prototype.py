...
"""search_country = "Senegal"
search_skills  = "Internet usage,Leadership,Photoshop,Presentation skills,Training,Windows PC usage"
search_bck_skills = "Business administration,Environmental engineering"""
#search_country = ""
#search_skills  = ""
#search_bck_skills = ""
...
#########Apply Filter on Opportunity Start####################################
    ...
    #print("Skill Pref Filter")
    #print(fil_skills_pref)
    ind = country_ass[country_ass['country'] == search_country].index[0]
    #print(country_ass.iloc[ind,1])
    ...
    common_functions.intersectOpportunities_skill = []
    common_functions.intersectOpportunities_back = []
    ...
    fil_stf_sp_bg = fil_stg_sp_bg.iloc[:,[0,1,2,5,9,12]]
    fil_stf_sp_bg['intersect_skill'] = common_functions.intersectOpportunities_skill
    fil_stf_sp_bg['intersect_back'] = common_functions.intersectOpportunities_back
    fil_stf_sp_bg = fil_stf_sp_bg.sort_values(by=['app_by_opening_wei'],ascending=False)
    return fil_stf_sp_bg[0:18]
